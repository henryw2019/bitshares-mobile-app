...
class ActivityIndexCollateral : BtsppActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ImageView>(R.id.tip_link_curr_feed).setOnClickListener {
            ...
            goToWebView(resources.getString(R.string.kDebtTipTitleFeedAndCallPrice), "https://ctspp.io/qam.html#qa_feed_settlement")
        }
        findViewById<ImageView>(R.id.tip_link_ratio).setOnClickListener {
            //  [统计]
            btsppLogCustom("qa_tip_click", jsonObjectfromKVS("qa", "qa_ratio"))
            goToWebView(resources.getString(R.string.kDebtTipTitleWhatIsRatio), "https://ctspp.io/qam.html#qa_ratio")
        }
        findViewById<ImageView>(R.id.tip_link_target_ratio).setOnClickListener {
            ...
            goToWebView(resources.getString(R.string.kDebtTipTitleWhatIsTargetRatio), "https://ctspp.io/qam.html#qa_target_ratio")
        }
