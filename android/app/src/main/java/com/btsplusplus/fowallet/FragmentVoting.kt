        ...
        _data_array.forEach<JSONObject> {
            ...
            when (type) {
                kSecTypeCommitteeActive -> {
                    ...
                    auxArgs.put("kURL", "https://ctspp.io/qam.html#qa_committee")
                }
                kSecTypeCommitteeCandidate -> {
                    ...
                    auxArgs.put("kURL", "https://ctspp.io/qam.html#qa_committee_c")
                }
                kSecTypeWitnessActive -> {
                    ...
                    auxArgs.put("kURL", "https://ctspp.io/qam.html#qa_witness")
                }
                kSecTypeWitnessCandidate -> {
                    ...
                    auxArgs.put("kURL", "https://ctspp.io/qam.html#qa_witness_c")
                }
